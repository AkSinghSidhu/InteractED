...
import 'osi_model_page.dart';
import 'theme_notifier.dart';

class ComputerNetworksPage extends StatefulWidget {
  const ComputerNetworksPage({super.key});

  @override
  State<ComputerNetworksPage> createState() => _ComputerNetworksPageState();
}

class _ComputerNetworksPageState extends State<ComputerNetworksPage> {
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            onTap: () {
              if (topics[index] == 'OSI Model') {
                Navigator.push(
                  context,
                  PageRouteBuilder(
                    pageBuilder: (context, a, sa) => const OsiModelPage(),
